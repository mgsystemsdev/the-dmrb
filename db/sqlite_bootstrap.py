...
def initialize_sqlite_database(conn: ConnectionWrapper, db_path: str, schema_path: str) -> None:
...
def run_sqlite_integrity_check(conn: ConnectionWrapper) -> None:
...
def backup_sqlite_database(db_path: str, backup_dir: str, batch_id: int) -> str:
...
def ensure_sqlite_ready(conn: ConnectionWrapper) -> None:
    """
